...
namespace DialoguerEditor{
	public class ThemeEditorWindow : EditorWindow {
		...
		void OnGUI(){
			...
			GUI.Label(new Rect(titleRect.x + 2, titleRect.y + 3, position.width, 20), "Theme Editor", EditorStyles.boldLabel);
			
			Rect editorRect = new Rect(5,titleRect.y + titleRect.height + 5, position.width - 10, 130);
			...
			// ------------------ SCROLL BOX
			// VISUALS
			Rect scrollRect = new Rect(7,editorRect.y + editorRect.height + 7,position.width - 14, position.height - (editorRect.y + editorRect.height + 70));
			if(isPro){
